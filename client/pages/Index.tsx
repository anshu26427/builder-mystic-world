...
const CONTENT = [
  {
    id: "physics-bridge",
    title: "Balance the Bridge",
    subject: "Physics",
    grade: "6",
    duration: 15,
    difficulty: "Medium",
    tags: ["forces", "engineering"],
    description: "Apply forces to build a stable bridge.",
  },
  {
    id: "math-fractions",
    ...
    difficulty: "Easy",
    tags: ["fractions"],
    description: "Solve fraction puzzles against the clock.",
  },
  {
    id: "coding-scratch",
    title: "Scratch to Python",
    subject: "Coding",
    grade: "6",
    duration: 20,
    difficulty: "Medium",
    tags: ["logic", "variables"],
    description: "Transition from blocks to Python basics.",
  },
  {
    id: "chemistry-states",
    ...
    difficulty: "Easy",
    tags: ["matter"],
    description: "Classify solids, liquids, and gases with mini-games.",
  },
  {
    id: "bio-ecosystems",
    ...
    difficulty: "Medium",
    tags: ["food web"],
    description: "Balance a food web and keep your biome alive.",
  },
  {
    id: "math-ratios",
    ...
    difficulty: "Medium",
    tags: ["ratios"],
    description: "Use ratios to solve real-world scenarios.",
  },
];
...
const QUESTIONS = [
  {
    id: 1,
    q: "A bridge stays up because forces are...",
    options: ["Unbalanced", "Balanced", "Random"],
    answer: 1,
  },
  { id: 2, q: "What is 3/4 + 1/4?", options: ["1/2", "1", "2/4"], answer: 1 },
  {
    id: 3,
    q: "A variable in code is best described as...",
    options: ["A fixed number", "A container for values", "A math operation"],
    answer: 1,
  },
];
      ...
      <section className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-violet-600 to-sky-500 px-6 py-16 sm:px-12 text-white">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <p className="mt-4 text-white/90 text-lg">
            Personalized learning paths, interactive games, and real-time
      ...
      <section className="mt-12 grid gap-6 md:grid-cols-3">
        {[
          ...
          },
          {
            ...
            desc: "Puzzles, quests, and quizzes that make learning fun.",
          },
          {
            title: "Secure & Safe",
            desc: "Privacy-first design built for classrooms and families.",
          },
        ].map((f, i) => (
          <Card key={i}>
      ...
      <section id="dashboard" className="mt-16 scroll-mt-24">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Your personalized STEM learning hub
            </p>
          </div>
          <a href="#library">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <BrainCircuit className="h-5 w-5 text-primary" /> Learning Path
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Rocket className="h-5 w-5 text-primary" /> New Challenges
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="border rounded-md p-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Apply forces to build a stable bridge.
                </p>
                <a href="#game">
              ...
              <div className="border rounded-md p-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Solve fraction puzzles against the clock.
                </p>
                <a href="#game">
                  <Button size="sm" className="mt-2">
                    Play
          ...
          <TabsContent value="overview">
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Zap className="h-5 w-5 text-primary" /> Quick Practice
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3 text-sm">
                  <div className="flex items-center justify-between">
          ...
          <TabsContent value="recommendations">
            <Card>
              <CardContent className="p-6 text-sm text-muted-foreground">
                Based on your progress, we recommend starting "Ratios in Real
                Life" and continuing "Forces & Motion: Level 3".
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">
            STEM Content Library
          </h2>
          <p className="text-muted-foreground">
            Browse topics, games, and modules by subject and grade level
          </p>
        </div>
        <a href="#dashboard">
        ...
        <CardContent className="p-6 grid gap-4 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <div className="relative">
              ...
              <Input
                id="search"
                placeholder="Search topics, tags, or modules"
                className="pl-9"
                value={query}
          ...
          <Select value={subject} onValueChange={setSubject}>
            ...
            <SelectContent>
              {"all,Math,Physics,Chemistry,Biology,Coding"
                .split(",")
                .map((s) => (
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2 text-xs text-muted-foreground">
                <span className="inline-flex items-center gap-1">
                  <Timer className="h-3.5 w-3.5" /> {c.duration}m
                </span>
    ...
    <section id="game" className="mt-16 scroll-mt-24">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Answer questions and earn badges
          </p>
        </div>
        <a href="#library">
      ...
      <Card className="mt-6">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Trophy className="h-4 w-4" /> Score {score}/{QUESTIONS.length}
            </div>
          </div>
          <Progress className="mt-4" value={finished ? 100 : progress} />
          {!finished ? (
            <div className="mt-6">
              <h3 className="text-xl font-semibold">{current.q}</h3>
    ...
    <section id="admin" className="mt-16 scroll-mt-24">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor student progress, assign content, and manage users
          </p>
        </div>
        <a href="#library">
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Users className="h-5 w-5 text-primary" /> Class Overview
            </CardTitle>
          </CardHeader>
              ...
              <TableBody>
                {[
                  ...
                  },
                  {
                    name: "Liam Chen",
                    grade: 6,
                    quest: "Ratios in Real Life",
                    progress: 40,
                  },
                  {
                    name: "Mia Garcia",
                    grade: 5,
                    quest: "Fraction Frenzy",
                    progress: 80,
                  },
                ].map((s) => (
                  <TableRow key={s.name}>
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <BookOpen className="h-5 w-5 text-primary" /> Assign Content
          </CardTitle>
        </CardHeader>
